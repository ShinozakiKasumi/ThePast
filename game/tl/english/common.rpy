## game/tl/english/common.rpy — English translations for UI strings
## All strings wrapped in _() in screens.rpy and options.rpy are translated here.
...
translate english strings:
    ...
    old "確定要從上次的位置繼續嗎？"
    new "Are you sure you want to continue from where you left off?"

    old "確定要結束回放嗎？"
    new "Are you sure you want to end the replay?"

    old "確定要開始跳過嗎？"
    new "Are you sure you want to start skipping?"

    old "確定要跳到下一個選擇嗎？"
    new "Are you sure you want to skip to the next choice?"

    old "確定要跳過未讀對話到下一個選擇嗎？"
    new "Are you sure you want to skip unseen dialogue to the next choice?"

    ## ── 占位对话（script.rpy） ──
    old "【占位台詞01】走廊的日光燈嗡嗡作響，抖動的像素像舊檔案的噪點。"
    new "[Placeholder 01] The fluorescent lights in the corridor buzz, jittering pixels like noise from old archives."

    old "【占位台詞02】這裡是角色台詞，名字欄、臉部框、立繪同時出現。"
    new "[Placeholder 02] Character dialogue appears with name box, face frame, and sprite simultaneously."

    old "【占位選擇】你要往哪裡走？"
    new "[Placeholder Choice] Where do you want to go?"

    old "往教室走"
    new "To the classroom"

    old "往校門走"
    new "To the school gate"

    old "【占位台詞03】你做出了選擇。本階段僅驗證 UI，結束回標題。"
    new "[Placeholder 03] You made a choice. This phase only verifies UI, returning to title."
# TODO: Translation updated at 2026-08-09 15:35
